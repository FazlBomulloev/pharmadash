...
export default function KpiCard({
  ...
  return (
    <div className="relative rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
      <div className="p-5">
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 bg-slate-50 text-slate-500 ring-1 ring-inset ring-slate-200">
            <Icon size={18} />
          </div>
        </div>
        <p className="text-2xl font-bold text-slate-800 mb-1 tabular-nums">{value}</p>
        {hint && (
