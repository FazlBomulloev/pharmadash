...
# Дефолтный курс USD/RUB — применяется к существующим рынкам при миграции
# и к новым рынкам при создании, пока пользователь не введёт свой.
FX_RATE_USD_RUB_DEFAULT = 75.20

# Статусы РУ, считающиеся «активными» при подсчёте grls_active_count.
